...
class HomeContent extends StatelessWidget {
  ...
  HomeContent({required this.updateNotes});
  ...
  Widget _buildSubjectCard(BuildContext context, String subject, String imagePath, String subjectKey) {
    return GestureDetector(
      onTap: () {
        // Navigate to the existing note page for the selected subject
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => NotesPage(subject: subjectKey, updateNotes: updateNotes),
          ),
        );
      },
      child: Container(
